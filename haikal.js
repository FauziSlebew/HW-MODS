...
await haikal.sendButtonText(m.chat, buttonsntnssfww, `Haii 👋 Kak ${pushname} Selamat ${salam} *Aku Adalah Bot 𝙁𝘼𝙐𝙕𝙄*
...
let user = global.db.data.users[m.sender]
anjay(`
Hello Saya Bot 𝙁𝘼𝙐𝙕𝙄${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
"orderMessage": {
						...
						"message": `© 𝙁𝘼𝙐𝙕𝙄 WA${ngazap(prefix)}`,
...
user.afkReason = text
deploy(`${m.pushName} Hello Saya Bot 𝙁𝘼𝙐𝙕𝙄${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugstik':{
...
touchmebre = [
{
title: `🌷 𝙁𝘼𝙐𝙕𝙄🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `🌷 𝙁𝘼𝙐𝙕𝙄 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'hu': {
if (!isCreator) return
...
const buttonMessage = {
tutor = fs.readFileSync('./tutor/tutor.mp3')
haikal.sendMessage(m.chat, {audio: tutor, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
